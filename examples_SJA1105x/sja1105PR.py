...
c = conf.Configuration(deviceid=SJA1105PR_DEVICEID, validating=1)

#############################################################################
# General Parameters
#############################################################################

general_parameters = conf.make_table_by_layout(sja1105pqrs.general_parameters_table_layout, sja1105pqrs.layoutid_map)
...
mac_configuration_table = conf.make_table_by_layout(sja1105pqrs.mac_configuration_table_layout, sja1105pqrs.layoutid_map)
...
credit_based_shaping_table = conf.make_table_by_layout(sja1105pqrs.credit_based_shaping_table_layout, sja1105pqrs.layoutid_map)
...
vlan_lookup_table = conf.make_table_by_layout(sja1105pqrs.vlan_lookup_table_layout, sja1105pqrs.layoutid_map)
...
l2_lookup_parameters_table = conf.make_table_by_layout(sja1105pqrs.l2_lookup_parameters_table_layout, sja1105pqrs.layoutid_map)
...
l2_address_lookup_table = conf.make_table_by_layout(sja1105pqrs.l2_address_lookup_table_layout, sja1105pqrs.layoutid_map)
...
l2_policing_table = conf.make_table_by_layout(sja1105pqrs.l2_policing_table_layout, sja1105pqrs.layoutid_map)
...
l2_forwarding_table = conf.make_table_by_layout(sja1105pqrs.l2_forwarding_table_layout, sja1105pqrs.layoutid_map)
...
avb_parameters = conf.make_table_by_layout(sja1105pqrs.avb_parameters_table_layout, sja1105pqrs.layoutid_map)
...
mii_mode_parameters = conf.make_table_by_layout(sja1105pqrs.mii_mode_parameters_table_layout, sja1105pqrs.layoutid_map)
...
sgmii_configuration = conf.make_table_by_layout(sja1105pqrs.sgmii_configuration_table_layout, sja1105pqrs.layoutid_map)

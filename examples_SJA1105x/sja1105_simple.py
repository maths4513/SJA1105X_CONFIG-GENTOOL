...
c = conf.Configuration(deviceid=SJA1105_DEVICEID, validating=1)

#############################################################################
# General Parameters
#############################################################################

general_parameters_table = conf.make_table_by_layout(sja1105.general_parameters_table_layout, sja1105.layoutid_map)
...
mac_configuration_table = conf.make_table_by_layout(sja1105.mac_configuration_table_layout, sja1105.layoutid_map)
...
vlan_lookup_table = conf.make_table_by_layout(sja1105.vlan_lookup_table_layout, sja1105.layoutid_map)
...
l2_lookup_parameters_table = conf.make_table_by_layout(sja1105.l2_lookup_parameters_table_layout, sja1105.layoutid_map)
...
l2_policing_table = conf.make_table_by_layout(sja1105.l2_policing_table_layout, sja1105.layoutid_map)
...
l2_forwarding_table = conf.make_table_by_layout(sja1105.l2_forwarding_table_layout, sja1105.layoutid_map)
...
mii_mode_parameters_table = conf.make_table_by_layout(sja1105.mii_mode_parameters_table_layout, sja1105.layoutid_map)
